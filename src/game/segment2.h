...
extern Gfx dl_draw_text_bg_header_orange[];
extern Gfx dl_draw_text_bg_header_blue[];
extern Gfx dl_draw_text_bg_header_green[];
extern Gfx dl_draw_text_option_box[];
