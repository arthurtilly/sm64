...
#define END_DIALOG {NULL, NULL, -1, -1, -1}
...
struct DialogBox dialog_test[] = {
    {name_monobup, dialog_test_monobup_1, -1, DIALOG_HEADER_ORANGE, -1},
    {name_janai, dialog_test_janai_1, -1, DIALOG_HEADER_ORANGE, -1},
    END_DIALOG,
};
...
struct DialogBox dialog_hifumi_intro[] = {
    {name_hifumi, dialog_hifumi_intro_1, -1, DIALOG_HEADER_ORANGE, -1},
    {name_hifumi, dialog_hifumi_intro_2, -1, DIALOG_HEADER_ORANGE, -1},
    END_DIALOG,
};
...
struct DialogBox dialog_game_start[] = {
    {name_mario, dialog_game_start_1, -1, DIALOG_HEADER_ORANGE, -1},
    {name_mario, dialog_game_start_2, -1, DIALOG_HEADER_GREEN, -1},
    {name_mario, dialog_game_start_3, -1, DIALOG_HEADER_BLUE, -1},
    {name_mario, dialog_game_start_4, -1, DIALOG_HEADER_BLUE, -1},
    {name_mario, dialog_game_start_5, -1, DIALOG_HEADER_GREEN, -1},
    {name_mario, dialog_game_start_6, -1, DIALOG_HEADER_ORANGE, DIALOG_PROC_PLAY_MUSIC_BBH},
    END_DIALOG,
};
...
struct DialogBox dialog_change_music[] = {
    {name_jukebox, dialog_change_music_1, -1, DIALOG_HEADER_GREEN, -1},
    END_DIALOG,
};
...
struct DialogBox dialog_change_music_bbh[] = {
    {name_jukebox, dialog_change_music_bbh_1, -1, DIALOG_HEADER_GREEN, DIALOG_PROC_PLAY_MUSIC_BBH},
    END_DIALOG,
};

struct DialogBox dialog_change_music_koopa_final[] = {
    {name_jukebox, dialog_change_music_koopa_final_1, -1, DIALOG_HEADER_GREEN, DIALOG_PROC_PLAY_MUSIC_SLIDE},
    END_DIALOG,
};

struct DialogBox dialog_change_music_file_select[] = {
    {name_jukebox, dialog_change_music_file_select_1, -1, DIALOG_HEADER_GREEN, DIALOG_PROC_PLAY_MUSIC_FILE_SELECT},
    END_DIALOG,
};

struct DialogBox dialog_change_music_ddd[] = {
    {name_jukebox, dialog_change_music_ddd_1, -1, DIALOG_HEADER_GREEN, DIALOG_PROC_PLAY_MUSIC_DDD},
    END_DIALOG,
};
